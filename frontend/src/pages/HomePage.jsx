...
const FEATURES = [
  ...
  },
  {
    num: '06',
    id: 'feature-pillscan',
    title: 'Pill Visual Identifier',
    description: 'Identify pill shape and color on-device and run ONNX classifier to match against standard dosage rules and warnings.',
    path: '/pill-scan',
    Icon: Icons.PillScan,
    status: 'Beta',
    cta: 'Scan a Pill',
  },
  {
    num: '07',
    id: 'feature-reports',
    title: 'Lab Report Locker',
    description: 'Binarize reports, isolate table structure and perform Tesseract OCR to decrypt biomarkers and track historical health trends.',
    path: '/reports',
    Icon: Icons.Report,
    status: 'Live',
    cta: 'Open Report Locker',
  },
  {
    num: '08',
    id: 'feature-firstaid',
